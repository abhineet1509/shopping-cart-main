  ...
  return(
    <div >
      <nav className="  flex flex-row justify-between items-center h-20 max-w-6xl mx-auto">
        ...
        <NavLink to="/">
        <p className=" hover:text-[#000000]">Home</p>
        </NavLink>
        <NavLink to="/cart">

          <div className=" relative">
          <FaShoppingCart className="  hover:text-[#000000] text-2xl"/>
          {
            cart.length > 0 &&
            <span className=" absolute  -top-1  -right-2 bg-[#000000] text-xs w-5 h-5
